  ...
  },
  {
    ...
    materials: [
      ...
      },
      {
        id: "M3",
        name: "3단계 수익 시뮬레이션",
        description: "월 3천/5천/8천만 기준 마진·영업이익금 계산",
        status: "needed",
        source: "미팅 3차",
        notes: "본부에 라이트 매장 마진 계산 자료 요청 중",
      },
      {
        id: "M4",
        name: "원가율 비교",
    ...
    materials: [
      {
        id: "E1",
        name: "조리 프로세스 시각화",
        description: "육수팩 → 데움 → 면 삶기 → 토핑. 10분 내 완성",
        status: "partial",
        source: "미팅 2차",
        notes: "프로세스 확인됨. 사진/영상 촬영 필요",
      },
      {
        id: "E2",
        name: "교육 커리큘럼",
        description: "현장교육 + 오픈 전 3일 + 오픈 후 3일 밀착",
        status: "confirmed",
        source: "미팅 2차",
      },
      {
        id: "E3",
        name: "SV 관리 체계",
        description: "초기 3개월 20회+ 방문, 직원처럼 상주",
        status: "confirmed",
        source: "미팅 2차",
      },
      {
