...
export const mainSections: MainSection[] = [
  {
    ...
    content: [
      ...
      },
      {
        type: "highlight",
        value:
          "LP에 들어가는 모든 내용은 \"우리가 자랑하고 싶은 것\"이 아니라, \"예비 점주가 불안해하는 것\"에 답해야 합니다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: "highlight",
        value:
          "LP는 왼쪽(표면 질문)이 아니라 오른쪽(진짜 불안)에 답해야 합니다.",
      },
    ],
  },
  {
    id: "three-needs",
    title: "타겟의 문제 = LP가 해결할 것",
    ...
    content: [
      ...
      },
      {
        type: "text",
        value:
          "LP의 모든 섹션은 이 3가지 중 하나를 증명하기 위해 존재해야 합니다. 어떤 재료로 증명할 수 있는지, 지금부터 같이 정리합시다.",
      },
    ],
  },
];
